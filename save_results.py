        ...
        for s_idx, student_dim in enumerate(student_dims):
            ...
            if gnc:
                ...
                for seed in range(num_seeds):
                    ...
                    row[f"gnc_gen_seed={seed}_theoretical"] = gnc_theoretical_losses[t_idx, s_idx, seed]
                    row[f"gnc_gen_seed={seed}_asymptotic"] = gnc_theoretical_asymptotic_losses[t_idx, s_idx, seed]
