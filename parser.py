...
def parse_args() -> argparse.Namespace:  # noqa: C901 – a bit long but flat
    ...
    g.add_argument("--data_file", type=pathlib.Path, help="Path to file containing alpha-W pairs (overrides seed-based generation)")
    ...
    g.add_argument("--gd_scheduler", type=str, default=None, help="Scheduler for GD", choices=["none", "step", "exponential", "cosine", "adaptive"])
